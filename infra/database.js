...
async function query(queryObject) {
  ...
  let client;
  try {
    client = await getNewClient(); // espera a conexão com o banco de dados ser estabelecida, ou seja, ela vai esperar o banco de dados responder que a conexão foi estabelecida, antes de continuar executando o próximo código.
